...
public class ADLCosFunction : ADLFunction{
    public ADLCosFunction(string name) : base(name){
    ...
    public override object PerformFunction(){
        ...
        return this.getAmplitude() * Math.Cos((this.getTangentialSpeed() * timePassed) + this.getPhase());   
    }
}